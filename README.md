...
В результате тестирования кеширования подтверждена корректная работа механизма: первый запрос возвращает статус MISS, последующие запросы в течение 30 секунд - статус HIT, что свидетельствует об эффективном использовании кеша Nginx.
